...
public class MovieService: IMovieService
{
    ...
    public Task<int> GetCountAsync(string? title, int? yearOrRelease, CancellationToken token = default)
    {
        return _movieRepository.GetCountAsync(title, yearOrRelease, token);
    }
}